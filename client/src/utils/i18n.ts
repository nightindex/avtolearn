...
export const ruDictionary: Record<string, string> = {
  ...
  "Profilni yangilab bo'lmadi": "Не удалось обновить профиль",
  "Avatar rasmi URL": "URL изображения аватара",
  "Avatar rasmini yuklash": "Загрузить фото профиля",
  "Rasm tanlash": "Выбрать фото",
  "Yangi avatar tanlandi": "Новый аватар выбран",
  "PNG, JPG yoki WebP. Maksimal hajm 2MB.": "PNG, JPG или WebP. Максимальный размер 2MB.",
  "Avatarni olib tashlash": "Удалить аватар",
  "Avatar rangi": "Цвет аватара",
  "Avatar o'lchami": "Размер аватара",
  "Avatar rangi va o'lchamini sozlang": "Настройте цвет и размер аватара",
  "O'zgartirmaslik uchun bo'sh qoldiring": "Оставьте пустым, чтобы не менять",
